...
Aquesta funció de densitat és la d'una [distribució exponencial](https://en.wikipedia.org/wiki/Exponential_distribution). Aquesta distribució queda completament determinada a partir d'un únic paràmetre $\lambda$ conegut com a _taxa_.
