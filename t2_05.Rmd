...
Aquesta funció de densitat és la d'una [distribució exponencial](https://en.wikipedia.org/wiki/Exponential_distribution). Aquesta distribució que completament determinada a partir d'un únic paràmetre que es sol denotar amb la lletra $\lambda$. El paràmetre $\lambda$ es coneix amb el nom de taxa.
